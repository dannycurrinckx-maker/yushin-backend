-- Yushin SaaS — initiële databaseschema, Postgres-versie (Render).
-- 1:1-vertaling van migrations/0001_init.sql (D1/SQLite): enkel
-- datetime('now') -> NOW() en de SQLite-only PRAGMA weggelaten (Postgres
-- handhaaft foreign keys altijd). Verder identiek — zie dat bestand voor de
-- volledige toelichting per tabel.
